...
class GNOM_manual(torch.optim.Optimizer):
    ...
    def __init__(self, params, base_optimizer, model, rho_scheduler=None,
        ...
        super(GNOM_manual, self).__init__(params, defaults)
    ...
    def zero_grad(self, set_to_none: bool = False):
        ...
        Args:
            set_to_none (bool): Instead of setting to zero, set the grads to None.
                This can slightly improve performance and reduce memory consumption.
        """
                ...
                if p.grad is not None:
                    if set_to_none:
                        ...
                        if p.grad.grad_fn is not None:
                            ...
                            # This should never happen since gradients should require grad
                            pass
                        p.grad.zero_()
    ...
    def __repr__(self):
        return f'GNOM_manual({self.base_optimizer.__class__.__name__})'